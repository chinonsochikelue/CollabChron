...
export default WritePage;I want the quill editor image to be uploaded to firebase and replace the html with the image URL instead of React quill converting it to base64, no bugs please
