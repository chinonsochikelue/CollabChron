...
const PrivacyPolicy = () => {
  return (
    <div className="text-start">
      <h1 className='font-bold text-4xl text-center'>Privacy Policy</h1>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to CollabChron.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to CollabChron, accessible from{" "}
            <a
      ...
      <h2 className="font-bold text-3xl text-center">Collecting and Using Your Personal Data</h2>
      ...
      <h4 className="font-semibold text-xl* text-center">Information from Third-Party Social Media Services</h4>
      <p>
      ...
      <h4 className="font-semibold text-xl text-center">Tracking Technologies and Cookies</h4>
      <p>
      ...
      <h3 className="font-semibold text-2xl text-center">Use of Your Personal Data</h3>
      ...
      <h3 className="font-semibold text-2xl text-center">Retention of Your Personal Data</h3>
      <p>
      ...
      <h3 className="font-semibold text-2xl text-center">Transfer of Your Personal Data</h3>
      <p>
      ...
      <h3 className="font-bold text-2xl text-center">Delete Your Personal Data</h3>
      <p>
      ...
      <h3 className="font-semibold text-2xl text-center">Disclosure of Your Personal Data</h3>
      ...
      <h3 className="font-bold text-2xl text-center">Security of Your Personal Data</h3>
      <p>
      ...
      <h2 className="font-bold text-2xl text-center">Children&apos;s Privacy</h2>
      <p>
      ...
      <h2 className="font-bold text-2xl text-center">Links to Other Websites</h2>
      <p>
      ...
      <h2 className="font-bold text-2xl text-center">Changes to this Privacy Policy</h2>
      <p>
      ...
      <ul>
        <li>By email: chinonsoneft@gmail.com</li>
      </ul>
    </div>
  );
};
