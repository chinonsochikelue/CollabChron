  ...
  return (
    <div className="relative pb-20">
      <div className="absolute inset-x-0 top-0 h-96 overflow-hidden">
        <div
          className="absolute left-1/2 -translate-x-1/2 top-0 -translate-y-1/2 bg-white/5 blur-3xl"
      ...
      <div className="w-full max-w-screen-xl mx-auto px-4 sm:px-8 lg:px-16 pt-32">
        <motion.h2
          ...
          viewport={{ once: true }}
          className="text-2xl sm:text-3xl lg:text-4xl text-center mb-16 font-semibold"
        >
        ...
        <div>
          ...
          >
            <motion.div variants={item} className="h-full flex items-center">
              <div className="relative h-8 w-8">
                <div className="relative w-full h-full overflow-hidden rounded-full border  border-gray-600 dark:border-white shadow-lg">
                  <Image
                    src="/avatar1.webp"
                    alt="Avatar-Image"
                    width={100}
            ...
            <motion.div
              variants={item}
              className="hidden sm:flex h-full items-end"
            >
              <div className="relative h-14 w-14">
                <div className="relative w-full h-full overflow-hidden rounded-full border  border-gray-600 dark:border-white shadow-lg">
                  <Image
            ...
            <motion.div
              variants={item}
              className="hidden sm:flex h-full items-start"
            >
              <div className="relative h-8 w-8">
                <div className="relative w-full h-full overflow-hidden rounded-full border  border-gray-600 dark:border-white shadow-lg">
                  <Image
            ...
            <motion.div
              variants={item}
              className="hidden sm:flex h-full items-center"
            >
              <div className="relative h-8 w-8">
                <div className="relative w-full h-full overflow-hidden rounded-full border  border-gray-600 dark:border-white shadow-lg">
                  <Image
          ...
          <motion.div
            ...
            whileInView="visible"
            viewport={{ once: true }}
            className="sm:hidden h-28 flex justify-between"
          >
            <motion.div variants={item} className="h-full flex items-end">
              <div className="relative h-14 w-14">
                <div className="relative w-full h-full overflow-hidden rounded-full border  border-gray-600 dark:border-white shadow-lg">
          ...
          <div className="flex mt-8 sm:mt-0">
            ...
            <motion.div
              ...
              className="pt-8 sm:w-1/3 lg:w-1/5 flex-col items-center"
            >
              {/* <a
                className="flex items-start justify-center mb-4"
                href="https://github.com/Effect-TS/effect/graphs/contributors"
              >
                <span>See all contributors</span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 11 14"
                  className="fill-current h-3.5 mt-0.5 ml-0.5"
                >
              ...
              <a
                className="inline-flex relative z-10 h-10 rounded-xl p-px shadow-lg button-hover bg-gradient-to-b from-white to-zinc-300 m-4"
                rel="noopener noreferrer"
                target="_blank"
                href="https://discord.gg/effect-ts"
              >
                <div className="flex items-center gap-1 px-6 font-medium rounded-[11px] whitespace-nowrap bg-white text-black">
                  <span>Join Facebook Page</span>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 384 512"
                    className="fill-current h-3.5 -mt-1"
                  >
                    <path d="M328 96h24v24V360v24H304V360 177.9L81 401l-17 17L30.1 384l17-17 223-223H88 64V96H88 328z"></path>
                  </svg>
                </div>
              </a>
            </motion.div>
